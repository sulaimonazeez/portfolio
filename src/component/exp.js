      ...
      <div className="container-fluid">
         <div className="bg-dark rounded container-fluid row">
            <div className="p-2 col-sm-12 col-md-6 col-lg-6 col-xl-6">
               ...
               <p className="full-de" style={{color:'lightgrey'}}>{this.props.des}</p>
               <p className="full-de" style={{color:'lightgrey'}}>{this.props.date}</p>
            ...
            <div className="p-2 col-sm-12 col-md-6 col-lg-6 col-xl-6">
               ...
               <p className="full-de" style={{color:'lightgrey'}}>{this.props.content}</p>
            </div>
         </div>
      </div>
    )
